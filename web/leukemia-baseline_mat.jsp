...
<body>
   ...
   <form role="form" action="GenerateReportServlet" method="post">
               ...
               <div class="form-horizontal" style="text-align: right;">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10 genrepmodal__checkboxgroup--position">
                           <input type="checkbox" name="age" value='1'> <label class="genrepmodal__checkboxes">Age</label> 
                           <input type="checkbox" name="gender" value='1'> <label class="genrepmodal__checkboxes">Gender</label> 
                           <input type="checkbox" name="modeOfTreatment" value='1'> <label class="genrepmodal__checkboxes">Mode of Treatment</label> 
                           <input type="checkbox" name="diseaseStatusBaseline" value='1'> <label class="genrepmodal__checkboxes">Disease Status Baseline</label> 
                           <input type="checkbox" name="diseaseStatusFollowup" value='1'> <label class="genrepmodal__checkboxes">Disease Status Follow-up</label>
                        </div>
                     </div>      
               </div>
            </div>
