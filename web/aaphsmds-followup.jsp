		...
		<div class="navbar navbar-default navbar-fixed-top">
			...
			<div class="nav-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="aaphsmds-baseline.jsp">AA,
							PHS, MDS</a></li>
			...
			<div class="row">
				<div class="col-sm-10 offset-sm-2 pull-right forms">
					...
					<div class="row button-container">
						<div class="col-sm-4">
							<a href="aaphsmds-baseline.jsp" type="button"
								class="btn bg-yellow">Baseline</a> <a
								href="aaphsmds-followup.jsp" type="button" class="btn bg-yellow">Follow
								Up</a>
						</div>
					</div>
							...
							<div class="tab-content">
								...
								<div id="laboratory" class="tab-pane fade in">
									...
									<div class="form-horizontal">
										...
										<!-- Fields -->
										<div class="form-group">
											<label class="control-label col-sm-4">Reticulocyte
												Count</label>
											<div class="col-lg-4">
												<input type="text" class="form-control"
