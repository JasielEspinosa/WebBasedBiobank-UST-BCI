...
$("#AddAAPHSMDSFollowup").submit(function(e) {
   e.preventDefault();
	});
...
$('document').ready(function(){
	...
	$("#baselineBtn").click(function() {
		...
		windows.location = ("aaphsmds-baseline.jsp").redirect();
...
function loadFollowupData(followupId){
	...
	$.post('LoadAAPHSMDSFollowupServlet', $.param(params), function (response) {
...
function actionBind(){
	$('#AddAAPHSMDSFollowup').submit(function() {
		alert($("#patientId").val());
		var $form = $(this);
		if(editState == false){
