$(document).ready(function() {
	...
	if ($("[name='familyHistoryOfThalassemia'][value='1']").is(":checked")) {
		$.familyHistoryOfThalassemiahecked();
	} else if ($("[name='familyHistoryOfThalassemia'][value='0']").is(":checked")) {
		$.familyHistoryOfThalassemiaChecked();
	}
	...
	if ($("[name='currentPastMedications'][value='1']").is(":checked")) {
		$.currentPastMedicationsChecked();
	} else if ($("[name='currentPastMedications'][value='0']").is(":checked")) {
		$.currentPastMedicationsUnchecked();
	}
	...
	$.hemoglobinElectrophoresisChecked = function() {
		...
		$("[name='hemoglobinElectrophoresisDatePerformed']").prop('required', true);
		$("#hemoglobinElectrophoresisDescription").slideDown(200);
		$("[name='hemoglobinElectrophoresisDescription']").prop('required', true);
		$("#hemoglobinElectrophoresisAttachScannedDocument").slideDown(200);
	}
	$.hemoglobinElectrophoresisUnchecked = function() {
		$("#hemoglobinElectrophoresisDatePerformed").slideUp(200);
		$("[name='hemoglobinElectrophoresisDatePerformed']").prop('required', false);
		$("#hemoglobinElectrophoresisDescription").slideUp(200);
		$("[name='hemoglobinElectrophoresisDescription']").prop('required', false);
		$("#hemoglobinElectrophoresisAttachScannedDocument").slideUp(200);
		$("[name='hemoglobinElectrophoresisAttachScannedDocument']").prop('required', false);
	...
	if ($("[name='hemoglobinElectrophoresis'][value='1']").is(":checked")) {
		$.hemoglobinElectrophoresisChecked();
	} else if ($("[name='hemoglobinElectrophoresis'][value='0']").is(":checked")) {
		$.hemoglobinElectrophoresisUnchecked();
	}
	...
	$.pertinentFindingsChecked = function() {
		...
		$("[name='pertinentFindingsOthers']").prop('required', true);
	}
	$.pertinentFindingsUnchecked = function() {
		$("#pertinentFindingsOthers").slideUp(200);
		$("[name='pertinentFindingsOthers']").prop('required', false);
	}
	...
	if ($("[name='pertinentFindings'][value='1']").is(":checked")) {
		$.pertinentFindingsChecked();
	} else if ($("[name='pertinentFindings'][value='0']").is(":checked")) {
		$.pertinentFindingsUnchecked();
	}
