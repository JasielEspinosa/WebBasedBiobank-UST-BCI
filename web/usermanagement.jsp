    ...
    <div class="container-fluid navbar__nav-item--hover">
     ...
     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <!-- Dropdown -->
       <li class="dropdown pull-right"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
     ...
     <div class="row">
      <div class="col-sm-10 offset-sm-2 settings__buttons--position">
       ...
       <div class="row button-container">
        <div class="col-sm-8">
         <a href="usermanagement.jsp" type="button" class="btn bg-yellow btn-responsive">User Management</a> <a href="archivedpatients.jsp"
          type="button" class="btn bg-yellow btn-responsive">Archived Patients</a>
        </div>
       </div>
       <!-- End of buttons container -->

       <!-- Table -->
       <h4 style="background-color: #ffce00; padding: 5px; font-weight: bold;">User Management</h4>
       <form>
        <table id="customers">
        <tr>
         <th><input type="checkbox" id="select_all"/></th> 
         <th onclick="sortTable(0)">Encoder Username</th>
         <th onclick="sortTable(1)">Encoder Name</th>
        </tr>
        <tr>
       ...
       <div id="usermanagement__popup" class="modal fade centered-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
         <div class="modal-content">
          ...
          <div class="modal-body">
           <form role="form">
            <div class="form-group">
             <label for="recipient-name" class="control-label">Username:</label> <input type="text" class="form-control" id="username">
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer">
           <button type="button" class="btn btn-primary" data-target="#confirm-submit" data-toggle="modal" id="submitBtn">Add</button>
       ...
       <div class="modal fade centered-modal" id="confirm-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
        data-backdrop="static">
        <div class="modal-dialog modal-sm">
         <div class="modal-content">
          <div class="modal-header">Confirm Submit</div>
          <div class="modal-body">
           Are you sure you want to add ancoder?
          </div>
          <div class="modal-footer">
