                              ...
                              <div id="laboratory" class="tab-pane fade">
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="bun" id="bun" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                       <span class="tooltipPointer1" title="Normal BUN Value: <br/> Male: 7 - 20 <br/> Female: 7-20
                                        <br /><br /> Reference: www.mercynorthiowa.com/cbc-normal-ranges" >
                                        	<i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                        </span>
                                       	<span id="bunStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="iCa" id="ionized" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                       <span class="tooltipPointer1" title="Normal Ionized Calcium Value ( mg/dl ): <br/> Male: 4.64 - 5.28 <br/> Female: 4.64 - 5.28
                                        <br /><br /> Reference: www.chemocare.com/chemotherapy/side-effects/hyperuricemia-high-uric-acid.aspx" >
                                        	<i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                        </span>
                                       	<span id="ionizedStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="totalProtein" id="totalprotein"/>
                                       </div>
                                       <div class="col-sm-4 status-position">
                                       <span class="tooltipPointer1" title="Normal Total Protein Value: <br/> Male: 6 - 8.3 <br/> Female: 6 - 8.3
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview" >
                                        	<i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                        </span>
                                       	<span id="totalproteinStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Albumin</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="albumin" id="albumin" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                       <span class="tooltipPointer1" title="Normal Albumin Value: <br/> Male: 3.5 - 5.5 <br/> Female: 3.5 - 5.5
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview" >
                                        	<i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                        </span>
                                       	<span id="albuminStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Globulin</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="globulin" id="globulin" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                       <span class="tooltipPointer1" title="Normal Globulin Value: <br/> Male: 2.0 - 3.5 <br/> Female: 2.0 - 3.5
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview" >
                                        	<i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                        </span>
                                       	<span id="globulinStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
