                      ...
                      <div class="form-horizontal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <div class="radio">
                              <label>
                                <input type="radio" name="thrombosisHistory" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="thrombosisHistory" value="0">
                                No
                              </label>
                            </div>
                          </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <script>
											var ctx = document.getElementById("myeloBaselinePatStatsChart").getContext('2d');
