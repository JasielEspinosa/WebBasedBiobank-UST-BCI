                  ...
                  <div class="col-md-12 forms">
                     ...
                     <div class="row button-container buttons__firsthalf--position" id="button-container">
                        <div class="col-sm-6 buttons__firsthalf-position">
                           <a href="aapnhmds-baseline.jsp" type="button" class="btn bg-yellow button-border baselinenbtn-text"
                              id="baselineBtn"> <span>Baseline</span>
                           </a> <a href="aapnhmds-followup.jsp" type="button" class="btn bg-yellow button-border followupnbtn-text"
                              ...
                              <div id="general" class="tab-pane fade in active">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-7">
                                          <input type="text" class="form-control" name="lastName" required id="lastName"> <span
                                             id="invalidName"></span>
                                       </div>
                                    </div>
                                    <!-- First Name -->
                              ...
                              <div id="clinical" class="tab-pane fade in active">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          <div class="radio">
                                             <label> <input type="radio" name="previousInfection" value="1" Required="Required">
                                                Yes
                                             </label>
                                          </div>
                                          <div class="radio">
                                             <label> <input type="radio" name="previousInfection" value="0"> No
                                             </label>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          ...
                                          <div class="radio">
                                             <label> <input type="radio" name="previousHematologicDisorder" value="0"> No
                                             </label>
                                          </div>
                                       </div>
                                    </div>
                              ...
                              <div id="laboratory" class="tab-pane fade">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="reticulocyteCount" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Serum iron</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="serumIron" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="serumFerritin" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Direct antiglobulin (Coombs) test (+/++/+++/-)</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="directAntiglobulin" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="serumFolicAcid" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Serum B12</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="serumB12" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">TSH</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0" onfocusout="setThreeNumberDecimal(this)" class="form-control" name="tsh" />
                                       </div>
                                    </div>
                                    <!-- End of fields -->
                                    <br />
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          ...
                                          <div class="radio">
                                             <label> <input type="radio" name="cytogeneticAndMolecularAnalysisAAPNH" value="0">
                                                Not Done
                                             </label>
                                          </div>
                                       </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          ...
                                          <div class="radio">
                                             <label> <input type="radio" name="cytogeneticAndMolecularAnalysisMDS" value="0">
                                                Not Done
                                             </label>
                                          </div>
                                       </div>
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class="col-md-10 col-md-offset-1">
                     <canvas id="aaBaselinePatStatsChart" width="500" height="400"></canvas>
                  </div>
               </div>
               <script>
																var ctx = document.getElementById("aaBaselinePatStatsChart").getContext(
																		'2d');
