            ...
            <div class="col-md-12 forms">
              ...
              <div class="row button-container buttons__firsthalf--position" id="button-container">
                <div class="col-sm-6 buttons__firsthalf-position">
                  ...
                  <a href="plasmacell-followup.jsp" type="button" class="btn bg-yellow button-border followupnbtn-text"
                    id="followUpBtn">
                    <span>FollowUp</span>
                  </a>
                </div>
                  ...
                  <div class="tab-content tab-content__border">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <select required class="form-control" name="diagnosis">
                              ...
                              <option value="C90.2 Extramedullary plasmacytoma">C90.2 Extramedullary
                                plasmacytoma</option>
                      ...
                      <div class="form-horizontal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="serumFreeLightChainAsssay" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="serumFreeLightChainAsssay" value="0">
                                No / Not Applicable
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group" id="serumFreeLightChainAsssayAttachScannedDocument"
                          style="display: none;">
                          <label class="control-label col-lg-4">Attach scanned document</label>
                          <div class="col-sm-8">
                            <input type="file" class="form-control"
                              name="serumFreeLightChainAsssayAttachScannedDocument" />
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="serumProteinElectrophoresis" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="serumProteinElectrophoresis" value="0">
                                No / Not Applicable
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group" id="serumProteinElectrophoresisAttachScannedDocument"
                          style="display: none;">
                          <label class="control-label col-lg-4">Attach scanned document</label>
                          <div class="col-sm-8">
                            <input type="file" class="form-control"
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="serumImmunofixation" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="serumImmunofixation" value="0">
                                No / Not Applicable
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="urineProtein" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="urineProtein" value="0">
                                No / Not Applicable
                              </label>
                            </div>
                          </div>
                    ...
                    <div id="therapy" class="tab-pane fade">
                      <div class="form-horizontal">
                        ...
                        <div class="form-group">
                          <label for="severity" class="control-label col-sm-4">Regimen/Protocol (For
                            nontransplant candidates)</label>
                          <div class="col-sm-8">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="bisphosphonates" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="bisphosphonates" value="0">
                                No
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="radiotherapy" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="radiotherapy" value="0">
                                No
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="dialysis" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <script>
											var ctx = document.getElementById("plasmaBaselinePatStatsChart").getContext('2d');
											var plasmaBaselinePatStatsChart = new Chart(ctx, {
												...
												data : {
													xLabels : [ 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul',
														'Aug', 'Sept',
														'Oct', 'Nov', 'Dec' ],
													yLabels : [ 'CR', 'sCR', 'Immunophenotypic CR', 
														'Molecular CR', 'VGPR', 'PR', 'MR', 'SD', 'PD',
														'Clinical Relapse', 'Relapse from CR', 'Others' ],
													datasets : [ {
