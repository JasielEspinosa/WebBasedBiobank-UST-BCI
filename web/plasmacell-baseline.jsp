                        ...
                        <div id="laboratory" class="tab-pane fade">
                           ...
                           <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <div class="radio">
                                       <label><input type="radio" name="cytogeneticAndMolecularAnalysis">Yes</label>
                                    </div>
                                    <div class="radio">
                                       <label><input type="radio" name="cytogeneticAndMolecularAnalysis">Not
                                          Done</label>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div id="therapy" class="tab-pane fade">
                           <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <div class="radio">
                                       <label><input type="radio" name="transplantCandidate">Yes</label>
                                    </div>
                                    <div class="radio">
                                       <label><input type="radio" name="transplantCandidate">No</label>
                                    </div>
                                 </div>
                              </div>
                              <!-- Treatment -->
                              ...
                              <h3 class="text-center">Other Treatment Modalities/Adjunctive treatment</h3>
                              <!-- Bisphosphonates -->
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control" name="speficyDoseAndFrequency" />
                                 </div>
                              </div>
                              <!-- Dialysis -->
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-8">
                                    <input type="date" class="form-control" name="otherMedications" />
                                 </div>
                              </div>
