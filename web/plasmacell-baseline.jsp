               ...
               <div class="col-md-12 forms">
                  ...
                  <div class="row button-container buttons__firsthalf--position ">
                     <div class="col-sm-6 buttons__firsthalf-position ">
                        <a href="plasmacell-baseline.jsp" type="button" class="btn bg-yellow button-border" id="baselineBtn">Baseline</a> <a
                           href="plasmacell-followup.jsp" type="button" class="btn bg-yellow button-border" id="followUpBtn">Follow Up</a>
                     </div>
                           ...
                           <div id="general" class="tab-pane fade in active">
                              ...
                              <div class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                    <div class="col-sm-1">
                                       <a alt="Barcode Icon" href="#"> <img alt="Barcode Icon" src="images/barcode.png"
                              ...
                              <div class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       <div class="radio">
                                          <label><input type="radio" name="serumFreeLightChainAsssay" value="0">No</label>
                                       </div>
                                       <div class="radio">
                                          <label><input type="radio" name="serumFreeLightChainAsssay" value="2">Not
                                             Applicable</label>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       <div class="radio">
                                          <label><input type="radio" name="serumProteinElectrophoresis" value="0">No</label>
                                       </div>
                                       <div class="radio">
                                          <label><input type="radio" name="serumProteinElectrophoresis" value="2">Not
                                             Applicable</label>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       <div class="radio">
                                          <label><input type="radio" name="serumImmunofixation" value="2">Not Applicable</label>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-sm-6">Urine protein electrophoresis/Immunofixation</label>
                                    <div class="col-sm-6">
                                       <div class="radio">
                                          <label><input type="radio" name="urineProteinElectrophoresisImmunofixation" value="1">Yes</label>
                                       </div>
                                       <div class="radio">
                                          <label><input type="radio" name="urineProteinElectrophoresisImmunofixation" value="0">No</label>
                                       </div>
                                       <div class="radio">
                                          <label><input type="radio" name="urineProteinElectrophoresisImmunofixation" value="2">Not
                                             Applicable</label>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                    <label for="severity" class="control-label col-sm-4">Regimen/Protocol (For transplant
                                       candidates)</label>
                                    <div class="col-sm-8">
                                       <select class="form-control" name="transplantRegimenProtocol">
                                          <option selected="selected" disabled="disabled">Select</option>
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-lg-4">Other Regimens</label>
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control" name="transplantOtherRegimens" />
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    <label for="severity" class="control-label col-sm-4">Regimen/Protocol (For nontransplant
                                       candidates)</label>
                                    <div class="col-sm-8">
                                       <select class="form-control" name="nonTransplantRegimenProtocol">
                                          <option selected="selected" disabled="disabled">Select</option>
                                          <option value="Bortezomib dexamethasone">Bortezomib dexamethasone</option>
                                          <option value="Bortezomib/Cyclophosphomide/dexamethasone">Bortezomib/Cyclophosphomide/dexamethasone</option>
                                          <option value="Bortezomib/Lenalidomide/dexamethasone">Bortezomib/Lenalidomide/dexamethasone</option>
                                          <option value="Lenalidomide/low dose Dexamethasone">Lenalidomide/low dose Dexamethasone</option>
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-lg-4">Other Regimens</label>
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control" name="nonTransplantOtherRegimens" />
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <select class="form-control" name="maintenanceTherapy">
                                          <option selected="selected" disabled="disabled">Select</option>
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-lg-4">Other Regimens</label>
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control" name="maintenanceTherapyOtherRegimens" />
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <div class="radio">
                                          <label><input type="radio" name="radiotherapy" value="1">Yes</label>
                                       </div>
                                       <div class="radio">
