...
<body>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                       <select class="form-control" name="phaseOfTheDisease">
                                          ...
                                          <option value="Newly Diagnosed ITP (within 3 months from diagnosis)">Newly Diagnosed ITP
                                             (within 3 months from diagnosis)</option>
                                          <option
                                             ...
                                             Persistent ITP (between 3-12 months from diagnosis. Includes patients not reaching spontaneous
                                             remission or not maintaining complete response off therapy)</option>
                                          ...
                                          <option
                                             ...
                                             occurrence of new bleeding symptoms requiring additional therapeutic intervention with a
   ...
   <script src="js/disease.plateletdisorder-baseline.js"></script>
</body>
</html>