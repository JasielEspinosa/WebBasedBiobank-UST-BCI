              ...
              <div class="row button-container buttons__firsthalf--position" id="button-container">
                <div class="col-sm-6 buttons__firsthalf-position">
                  <a href="plateletdisorder-baseline.jsp" type="button"
                    class="btn bg-yellow button-border baselinenbtn-text" id="baselineBtn">
                    <span>Baseline</span>
                  </a>
                  <a href="plateletdisorder-followup.jsp" type="button"
                    class="btn bg-yellow button-border followupnbtn-text" id="followUpBtn">
                    <span>FollowUp</span>
                  </a>
                </div>
                      ...
                      <div class="form-horizontal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="upperGIEndoscopy" value="1" required="required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="upperGIEndoscopy" value="0">
                                No
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group" id="hPylori" style="display: none;">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="hPylori" value="1" required="required">
                                Positive
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="hPylori" value="0">
                                Negative
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-8">
                            <select required class="form-control" name="diseaseStatus">
                              ...
                              <option value="Chronic ITP (lasting for more than 12 months)">Chronic ITP
                                (lasting for more than 12 months)</option>
                              <option
                                ...
                                Severe ITP (presence of bleeding symptoms at presentation sufficient to mandate
                                treatment, or occurrence of new bleeding symptoms requiring additional therapeutic
                                intervention with a different platelet-enhancing agent or an increased dose)</option>
                            </select>
                          </div>
                        </div>
                      </div>
