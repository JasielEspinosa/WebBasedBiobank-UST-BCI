                              ...
                              <div id="laboratory" class="tab-pane fade">
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step="any" class="form-control" name="anaTiter" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Hepatitis CRNA</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step="any" class="form-control" name="hepatitisCRNA" />
                                       </div>
                                    </div>
                                    <!-- Imaging Studies -->
                                    <div class="form-group">
