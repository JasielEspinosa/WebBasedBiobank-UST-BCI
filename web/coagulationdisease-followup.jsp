                  ...
                  <div class="tab-content tab-content__border">
                    ...
                    <div id="medicalEvents" class="tab-pane fade in active">
                      ...
                      <div class="form-horizontal">
                        ...
                        <br />
                        <div class="form-group">
                          <label class="control-label col-sm-6">Did the patient self-administered factor
                            concentrates at home from last visit?</label>
                          <div class="col-sm-6">
                            <div class="radio">
                              <label>
                                <input type="radio" name="factorConcentrate" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="factorConcentrate" value="0">
                                No
                              </label>
                            </div>
                          </div>
