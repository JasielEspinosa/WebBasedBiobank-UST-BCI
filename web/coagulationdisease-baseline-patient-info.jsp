                              ...
                              <div class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="factorVIIILevel"
                                          value="<%=coagulationTesting.getDouble("factorVIILevel")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="factorIXLevel"
                                          value="<%=coagulationTesting.getDouble("factorIXLevel")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="inhibitorAssay"
                                          value="<%=coagulationTesting.getDouble("inhibitorAssay")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="bethesdaUnits"
                                          value="<%=coagulationTesting.getDouble("bethesdaUnits")%>" />
                                    </div>
                                 </div>
                                 <!-- End of fields -->
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       <div class="radio">
                                          <label><input type="radio" name="imagingStudies" value="notApplicable">Not
                                             Applicable</label>
                                       </div>
                                    </div>
                                 </div>
