<jsp:useBean id="leukemiaPatientsList" type="java.sql.ResultSet"
	scope="request" />
...
<jsp:useBean id="laboratoryProfile" type="java.sql.ResultSet"
	scope="request" />
<jsp:useBean id="hematology" type="java.sql.ResultSet" scope="request" />
<jsp:useBean id="bloodChemistry" type="java.sql.ResultSet"
	scope="request" />
<jsp:useBean id="imagingStudies" type="java.sql.ResultSet"
	scope="request" />
<jsp:useBean id="boneMarrowAspirate" type="java.sql.ResultSet"
	scope="request" />
<jsp:useBean id="flowCytometry" type="java.sql.ResultSet"
	scope="request" />
<jsp:useBean id="cytogeneticAndMolecularAnalysis"
	type="java.sql.ResultSet" scope="request" />
<jsp:useBean id="therapyAndResponse" type="java.sql.ResultSet"
	scope="request" />
...
<script>
	$(document).ready(function(){
		...
		//Lymphadenopathies
		$("input[name=presenceOfLymphadenopathies][value=<%=physicalExam.getInt("lymphadenopathies")%>
	]")
								.prop('checked', true);
						...
						$("select[name=treatment]")
								.val(
<%=therapyAndResponse.getInt("modeOfTreatmentId")%>
	);
										...
										<div class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control"
														...
														value="<%=patientInfo.getInt("patientId")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" name="lastName"
														value="<%=generalData.getString("lastName")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" name="firstName"
														value="<%=generalData.getString("firstName")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control"
														name="middleInitial"
														value="<%=generalData.getString("middleName")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="date" class="form-control" name="dateOfBirth"
														value="<%=generalData.getString("dateOfBirth")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="text" class="form-control" name="address"
														value="<%=address.getString("streetAddress")%>, <%=address.getString("city")%>, <%=address.getString("zipCode")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													<input type="date" class="form-control" name="dateOfEntry"
														value="<%=generalData.getString("dateOfEntry")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-7">
													...
													<div class="radio">
														<label><input type="radio"
															name="tissueSpecimenCollected" value="2">No</label>
													</div>
												</div>
											</div>
								...
								<div class="tab-content">
									...
									<div id="clinical" class="tab-pane fade in active">
										...
										<div class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="date" class="form-control"
														...
														value="<%=clinicalData.getString("dateOfVisit")%>">
												</div>
											</div>
											...
											<div class="form-group">
												<label class="control-label col-sm-3">Classification/Risk
													Statification</label>
												<div class="col-sm-9">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control"
														name="chiefComplaint"
														value="<%=clinicalData.getString("chiefComplaint")%>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control"
														name="otherSymptoms"
														value="<%=clinicalData.getString("otherSymptoms")%>">
												</div>

												<!-- Family History of Cancer -->
												<div class="form-group">
													<label class="control-label col-sm-3">Family
														History of Cancer</label>
													<div class="col-sm-9">
														<div class="radio">
															<label><input type="radio"
																name="familyHistoryOfCancer" value="1">Yes</label>
														</div>
														<div class="radio">
															<label><input type="radio"
																name="familyHistoryOfCancer" value="2">No</label>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="control-label col-sm-3">Other
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control"
															name="comorbidities"
															value="<%=clinicalData.getString("combordities")%>">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<div class="radio">
															<label><input type="radio"
																name="concomitantMedications" value="2">No</label>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="radio">
															<label><input type="radio" name="smokingHistory"
																value="1">Yes</label>
														</div>
														<div class="radio">
															<label><input type="radio" name="smokingHistory"
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control"
															...
															value="<%=clinicalData.getString("smokingHistory")%>">
													</div>
												</div>

												<!-- Alcohol Intake History -->
												<div class="form-group">
													<label class="control-label col-lg-3">Alcohol
														intake history </label>
													<div class="col-sm-9">
														<div class="radio">
															<label><input type="radio"
																name="alcoholIntakeHistory" value="1">Yes</label>
														</div>
														<div class="radio">
															<label><input type="radio"
																name="alcoholIntakeHistory" value="2">No</label>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control"
															...
															value="<%=clinicalData.getString("alcoholIntakeHistory")%>" />
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<div class="radio">
															<label><input type="radio"
																name="chemicalExposureHistory" value="2">No</label>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control"
															...
															value="<%=clinicalData.getString("chemicalExposure")%>" />
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" name="height"
															value="<%=physicalExam.getDouble("height")%>" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" name="weight"
															value="<%=physicalExam.getDouble("weight")%>" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control" name="ecog"
															value="<%=physicalExam.getDouble("ecog")%>" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<div class="radio">
															<label><input type="radio"
																name="presenceOfSplenomegaly" value="2">No</label>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<div class="radio">
															<label><input type="radio"
																name="presenceOfHepatomegaly" value="2">No</label>
														</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" class="form-control"
															name="otherFindings"
															value="<%=physicalExam.getString("otherFindings")%>" />
													</div>
												</div>
									...
									<div id="laboratory" class="tab-pane fade">
										...
										<div class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="date" class="form-control"
														...
														value="<%=laboratoryProfile.getString("dateOfBloodCollection")%>" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="hemoglobin"
														value="<%=hematology.getDouble("hemoglobin")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="hematocrit"
														value="<%=hematology.getDouble("hematocrit")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control"
														...
														value="<%=hematology.getDouble("whiteBloodCells")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="neutrophils"
														value="<%=hematology.getDouble("neutrophils")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="lymphocytes"
														value="<%=hematology.getDouble("lymphocytes")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="monocytes"
														value="<%=hematology.getDouble("monocytes")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="eosinophils"
														value="<%=hematology.getDouble("eosinophils")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="basophils"
														value="<%=hematology.getDouble("basophils")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="myelocytes"
														value="<%=hematology.getDouble("myelocytes")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control"
														name="metamyelocytes"
														value="<%=hematology.getDouble("metamyelocytes")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="blasts"
														value="<%=hematology.getDouble("blasts")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control"
														name="plateletCount"
														value="<%=hematology.getDouble("plateletCount")%>" />
												</div>
											</div>
											<!-- End of Labels -->
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="creatinine"
														value="<%=bloodChemistry.getDouble("creatinine")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="uricAcid"
														value="<%=bloodChemistry.getDouble("uricAcid")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="na"
														value="<%=bloodChemistry.getDouble("na")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="k"
														value="<%=bloodChemistry.getDouble("k")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="sgot"
														value="<%=bloodChemistry.getDouble("sgot")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="sgpt"
														value="<%=bloodChemistry.getDouble("sgpt")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" class="form-control" name="ldh"
														value="<%=bloodChemistry.getDouble("ldh")%>" />
												</div>
											</div>
											<!-- End of fields -->
											...
											<!-- Imaging Studies -->
											<div class="form-group">
												<label class="control-label col-sm-4">Imaging
													Studies</label>
												<div class="col-sm-8">
													<div class="radio">
											...
											<div class="form-group">
												...
												<div class="col-lg-5">
													<input type="text" class="form-control"
														...
														value="<%=imagingStudies.getString("results")%>" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<div class="radio">
														<label><input type="radio"
															name="boneMarrowAspirate" value="2">No</label>
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="date" class="form-control"
														...
														value="<%=boneMarrowAspirate.getString("datePerformed")%>" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														...
														value="<%=boneMarrowAspirate.getString("result")%>" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<div class="radio">
														<label><input type="radio" name="flowCytometry"
															value="1">Yes</label>
													</div>
													<div class="radio">
														<label><input type="radio" name="flowCytometry"
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														...
														value="<%=flowCytometry.getString("result")%>" />
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-lg-4">Attach scanned
											...
											<div class="form-group">
												<label class="control-label col-sm-4">Cytogenetic
												...
												<div class="col-sm-8">
													...
													<div class="radio">
														<label><input type="radio"
															name="cytogeneticAndMolecularAnalysis" value="2">Not
															Done</label>
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														...
														value="<%=cytogeneticAndMolecularAnalysis.getString("result")%>" />
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-lg-4">Attach scanned
									...
									<div id="therapy" class="tab-pane fade">
										...
										<div class="form-horizontal">
											...
											<!-- Medications -->
											<div class="form-group">
												<label class="control-label col-lg-4">Chemotherapy
													Medications</label>
												<div class="col-sm-8">
													<input type="text" class="form-control"
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="cycleNumber"
														value="<%=therapyAndResponse.getInt("cycleNumber")%>" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="date" class="form-control" name="dateStarted"
														value="<%=therapyAndResponse.getString("dateStarted")%>" />
												</div>
											</div>
