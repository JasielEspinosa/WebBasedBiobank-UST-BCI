                              ...
                              <div id="laboratory" class="tab-pane fade">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0"
                                             onfocusout="setThreeNumberDecimal(this)" class="form-control" name="bilirubin" id="bilirubin" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                          <span class="tooltipPointer1"
                                             title="Normal Bilirubin Value: <br/> Male: 0.2 - 1.2 <br/> Female: 0.2 - 1.2
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview">
                                             <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                          </span> <span id="bilirubinStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0"
                                             onfocusout="setThreeNumberDecimal(this)" class="form-control" name="total" id="total" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                          <span class="tooltipPointer1"
                                             title="Normal Total Value: <br/> Male: 0.2 - 1.2 <br/> Female: 0.2 - 1.2
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview">
                                             <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                          </span> <span id="totalStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0"
                                             onfocusout="setThreeNumberDecimal(this)" class="form-control" name="direct" id="direct" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                          <span class="tooltipPointer1"
                                             title="Normal Direct Value: <br/> Male: 0 - 0.4 <br/> Female: 0.2 - 0.4
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview">
                                             <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                          </span> <span id="directStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0"
                                             onfocusout="setThreeNumberDecimal(this)" class="form-control" name="indirect" id="indirect" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                          <span class="tooltipPointer1"
                                             title="Normal Indirect Value: <br/> Male: 0 - 0.4 <br/> Female: 0.2 - 0.4
                                        <br /><br /> Reference: https://emedicine.medscape.com/article/2172316-overview">
                                             <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                          </span> <span id="indirectStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <!-- End Table -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0"
                                             onfocusout="setThreeNumberDecimal(this)" class="form-control" name="hepatitisBTesting"
                                             id="hepaB" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                          <span class="tooltipPointer1"
                                        ...
                                        <br /><br /> Reference: https://www.medicinenet.com/liver_blood_tests/article.htm">
                                             <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                          </span> <span id="hepaBStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step=".1" min="0"
                                             onfocusout="setThreeNumberDecimal(this)" class="form-control" name="esr" id="esr" />
                                       </div>
                                       <div class="col-sm-4 status-position">
                                          <span class="tooltipPointer1"
                                             title="Normal ESR Value: <br/> Male: 0 - 22 <br/> Female: 0 - 22 
                                        <br /><br /> Reference: https://www.webmd.com/a-to-z-guides/lactic-acid-dehydrogenase-test#2">
                                             <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                          </span> <span id="esrStatus" class="status"></span>
                                       </div>
                                    </div>
                                    <!-- Labels -->
