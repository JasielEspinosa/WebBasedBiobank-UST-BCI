				...
				<div class="container-fluid navbar__nav-item--hover">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="myelo-baseline.html">Myeloproliferative
									Neoplasm</a></li>
							<li><a href="plasmacell-baseline.html">Plasma Cell
									Disorder</a></li>
							<li><a href="aaphsmds-baseline.html">AA DNS MDS</a></li>
							<li><a href="plateletdisorder-baseline.html">Platelet
									Disorder</a></li>
							<li><a href="coagulationdisease-baseline.html">Coagulation
									Disease</a></li>
				...
				<div class="row">
					<div class="col-sm-10 offset-sm-2 pull-right forms">
						...
						<div class="row button-container">
							<div class="col-sm-4">
								<a href="lymphoma-baseline.jsp" type="button"
									class="btn bg-yellow">Baseline</a> <a
									href="lymphoma-followup.jsp" type="button"
						...
						<div class="row">
												...
												<div class="col-sm-7">
													<div class="radio">
														<label><input type="radio"
															name="tissueSpecimenCollectedYes">Yes</label>
													</div>
													<div class="radio">
														<label><input type="radio"
															name="tissueSpecimenCollectedNo">No</label>
													</div>
												</div>
											</div>
							...
							<div class="col-sm-8">
                              ...
                              Lymphoma of bronchial-associated lymphoid tissue (BALT-lymphoma) -->
											...
											<!-- Stage of Disease -->
											<div class="form-group">
												<label class="control-label col-sm-3">Stage of
													Disease</label>
												<div class="col-sm-9">
													<input type="text" class="form-control"
														name="stageOfDisease">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="radio">
														<label><input type="radio"
															name="alcoholIntakeHistory">Yes</label>
													</div>
													<div class="radio">
														<label><input type="radio"
															name="alcoholIntakeHistory">No</label>
													</div>
												</div>
											</div>
											<div class="form-group">
									...
									<div id="laboratory" class="tab-pane fade">
										...
										<div class="form-horizontal">
											...
											<div class="form-group">
												<label class="control-label col-sm-4">Beta-2-microglobulin
													mg/dl</label>
												<div class="col-lg-4">
													<input type="text" class="form-control" name="" />
												</div>
											...
											<div class="form-group">
												<label class="control-label col-sm-4">Hepatitis B
													Testing </label>
												<div class="col-lg-4">
													<input type="text" class="form-control" name="" />
												</div>
											...
											<div class="form-group">
												<label class="control-label col-sm-4">Hematopathology
													review of slides</label>
												<div class="col-sm-8">
													<div class="radio">
														<label><input type="radio"
															name="hematopathologyReviewOfSlides">Yes</label>
													</div>
													<div class="radio">
														<label><input type="radio"
															name="hematopathologyReviewOfSlides">No</label>
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="date" class="form-control"
														name="hematopathologyDatePerformed" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														name="hematopathologyDescription" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="control-label col-sm-4">Immunohistochemistry
													of tissue</label>
												<div class="col-sm-8">
													<div class="radio">
														<label><input type="radio"
															name="immunohistochemistryReviewOfSlides">Yes</label>
													</div>
													<div class="radio">
														<label><input type="radio"
															name="immunohistochemistryHematopathologyReviewOfSlides">No</label>
													</div>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<div class="radio">
														<label><input type="radio" name="flowCytometry">Not
															Applicable</label>
													</div>
												</div>
											</div>
