                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <select required class="form-control" name="diagnosis">
                              ...
                              <option value="">B21.2 HIV disease resulting in other types of non-Hodgkin
                                lymphoma</option>
                      ...
                      <div class="form-horizontal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="hematopathologyReviewOfSlides" value="1" Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="hematopathologyReviewOfSlides" value="0">
                                No
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <div class="radio">
                              <label>
                                <input type="radio" name="immunohistochemistryReviewOfSlides" value="1"
                                  Required="Required">
                                Yes
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input type="radio" name="immunohistochemistryReviewOfSlides" value="0">
                                No
                              </label>
                            </div>
                          </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <script>
											var ctx = document.getElementById("lymphomaBaselinePatStatsChart").getContext('2d');
											var lymphomaBaselinePatStatsChart = new Chart(ctx, {
												...
												data : {
													xLabels : [ 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul',
														'Aug', 'Sept',
														'Oct', 'Nov', 'Dec' ],
													yLabels : [ 'Newly Diagnosed', 'CR', 'PR', 'NR', 
														'PD', 'RR', 'Others' ],
													datasets : [ {
