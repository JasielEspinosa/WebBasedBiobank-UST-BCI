        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
              <canvas id="leukemiaBaselinePatStatsChart" width="600" height="500"></canvas>
            </div>
          </div>
          <script>
											var ctx = document.getElementById("leukemiaBaselinePatStatsChart").getContext('2d');
											var leukemiaBaselinePatStatsChart = new Chart(ctx, {
												type : 'line',
												data : {
													...
													yLabels : [ 'Newly Diagnosed', 'Relapsed', 'Refractory Disease', 'CR', 'nCR', 'PR', 'PD', 'SD',
														...
														'Major Molecular Response', 'Spleen Response', 'Symptom Response', 
														'Others' ],
													datasets : [ {
