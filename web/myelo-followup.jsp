...
<html>
<head>
<title>USTH - Myelo Follow Up</title>
<meta charset="utf-8">
   ...
   <div class="row-offcanvas row-offcanvas-left">
      ...
      <div id="main">
         <div class="col-md-12">
            ...
            <!-- End of Sidebar -->
            <!-- Forms Container -->
            <form action="AddMyeloFollowUpServlet" method="post">
               <div class="col-md-12">
                              ...
                              <div id="medicalEvents" class="tab-pane fade in active">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                          <div class="radio">
                                             <label><input type="radio" name="hematologicMalignancy" value="1" required="required" required="required">Yes</label>
                                          </div>
                                          <div class="radio">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                          ...
                                          <div class="radio">
                                             <label><input type="radio" name="0">No</label>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
