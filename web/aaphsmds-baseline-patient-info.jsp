            ...
            <div class="row">
               <div class="col-sm-10 offset-sm-2 pull-right forms">
                  ...
                  <div class="row button-container">
                     <div class="col-sm-4">
                        <a href="aaphsmds-baseline.jsp" type="button" class="btn bg-yellow">Baseline</a> <a
                           href="aaphsmds-followup.jsp" type="button" class="btn bg-yellow">Follow Up</a>
                     </div>
                  </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                       <input type="date" class="form-control" name="dateOfBirth"
                                          value="<%=generalData.getDate("dateOfBirth")%>">
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="date" class="form-control" name="dateOfVisit"
                                          value="<%=clinicalData.getDate("dateOfVisit")%>">
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <select class="form-control" name="diagnosis">
                                          ...
                                          <option value="D61.0  Constitutional aplastic anaemia">D61.0
                                             Constitutional aplastic anaemia</option>
                                          <option value="D61.1  Drug-induced aplastic anaemia">D61.1
                                             Drug-induced aplastic anaemia</option>
                                          <option value="D61.2  Aplastic anaemia due to other external agents">D61.2
                                             Aplastic anaemia due to other external agents</option>
                                          <option value="D61.3  Idiopathic aplastic anaemia">D61.3 Idiopathic
                                             aplastic anaemia</option>
                                          <option value="D61.8  Other specified aplastic anaemias">D61.8 Other
                                             specified aplastic anaemias</option>
                                          <option value="D61.9  Aplastic anaemia, unspecified">D61.9 Aplastic
                                             anaemia, unspecified</option>
                                          ...
                                          <option value="D46.1  Refractory anaemia with ring sideroblasts">D46.1
                                             Refractory anaemia with ring sideroblasts</option>
                                          ...
                                          <option value="D46.4  Refractory anaemia, unspecified">D46.4
                                             Refractory anaemia, unspecified</option>
                                          ...
                                          <option
                                             ...
                                             Myelodysplastic syndrome with isolated del(5q) chromosomal abnormality 5
                                             q-minus syndrome</option>
                                          <option value="D46.7  Other myelodysplastic syndromes">D46.7 Other
                                             myelodysplastic syndromes</option>
                                          <option value="D59.5  Paroxysmal Nocturnal Hemoglobinuria">D59.5
                                             Paroxysmal Nocturnal Hemoglobinuria</option>
                                          <option
                                             value="D59.6Haemoglobinuria due to haemolysis from other external causes">D59.6Haemoglobinuria
                                 ...
                                 <div class="form-group">
                                    <div class="row">
                                       ...
                                       <label class="control-label col-sm-3" style="text-align: left;">Generic
                                          Name</label> <label class="control-label col-sm-2" style="text-align: left;">Dose</label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control" name="previousInfectionSpecify"
                                          value="<%=clinicalData.getString("previousInfection")%>" />
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control" name="previousHematologicDisorderSpecify"
                                          value="<%=clinicalData.getString("previousHematologicDisorder")%>" />
                                    </div>
                                 </div>
                              ...
                              <div class="form-horizontal">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="creatinine"
                                          value="<%=otherLaboratories.getDouble("creatinineOther")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="uricAcid"
                                          value="<%=otherLaboratories.getDouble("uricAcid")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="reticulocyteCount"
                                          value="<%=otherLaboratories.getDouble("reticulocyteCount")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="serumIron"
                                          value="<%=otherLaboratories.getDouble("serumIron")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="ironBindingCapacity"
                                          value="<%=otherLaboratories.getDouble("ironBindingCapacity")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="serumFerritin"
                                          value="<%=otherLaboratories.getDouble("serrumFerritin")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label col-sm-4">Direct antiglobulin (Coombs) test
                                       (+/++/+++/-)</label>
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="directAntiglobulin"
                                          value="<%=otherLaboratories.getString("directAntiglobulin")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label col-sm-4">Indirect antiglobulin (Coombs)
                                       test(+/++/+++/-)</label>
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="indirectAntiglobulin"
                                          value="<%=otherLaboratories.getString("indirectAntiglobulin")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="sgot"
                                          value="<%=otherLaboratories.getDouble("sgot")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="sgpt"
                                          value="<%=otherLaboratories.getDouble("sgpt")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="ldh"
                                          value="<%=otherLaboratories.getDouble("ldh")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label col-sm-4">Screening tests for hepatitis viruses
                                       A, B, and C (+/-)</label>
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control"
                                          name="screeningTestsForHepatitisVirusesABC"
                                          value="<%=otherLaboratories.getString("screenTestHepatitis")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label col-sm-4">Screening tests for EBV,
                                       cytomegalovirus (CMV), and HIV (+/-)</label>
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="screeningTestsForEBVCMVHIV"
                                          value="<%=otherLaboratories.getString("screenTestEBVCytomegalovirusHIV")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="erythropoeitinLevel"
                                          value="<%=otherLaboratories.getDouble("erythropeitinLevel")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="serumFolicAcid"
                                          value="<%=otherLaboratories.getDouble("serumFolicAcid")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="serumB12"
                                          value="<%=otherLaboratories.getDouble("serumB12")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                       <input type="text" class="form-control" name="tsh"
                                          value="<%=otherLaboratories.getDouble("tsh")%>" />
                                    </div>
                                 </div>
                                 <!-- End of fields -->
                                 <br />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       <div class="radio">
                                          <label><input type="radio" name="flowCytometry" value="2">Not
                                             Applicable</label>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-sm-4">Cytogenetic and Molecular Analysis if
                                       for Aplastic Anemia and PNH</label>
                                    <div class="col-sm-8">
                                       <div class="radio">
                                          <label><input type="radio" name="cytogeneticAndMolecularAnalysisAAPNH"
                                             value="1">Yes</label>
                                       </div>
                                       <div class="radio">
                                          <label><input type="radio" name="cytogeneticAndMolecularAnalysisAAPNH"
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control"
                                          ...
                                          value="<%=cytogeneticAAPNH.getString("result")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label col-lg-4">Attach scanned document</label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <div class="radio">
                                          <label><input type="radio" name="cytogeneticAndMolecularAnalysisMDS"
                                             value="1">Yes</label>
                                       </div>
                                       <div class="radio">
                                          <label><input type="radio" name="cytogeneticAndMolecularAnalysisMDS"
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control"
                                          ...
                                          value="<%=cytogeneticMDS.getString("result")%>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label col-lg-4">Attach scanned document</label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                       <input type="date" class="form-control" name="dateStarted"
                                          value="<%=treatment.getString("dateStarted")%>" />
                                    </div>
                                 </div>
                              </div>
                              <!-- End of Form -->
