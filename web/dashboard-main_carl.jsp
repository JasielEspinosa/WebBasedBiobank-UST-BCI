                    ...
                    <div class="form-horizontal">
                      <div class="row">
                        ...
                        <div class="col-md-3 dashboard__framecontainer">
                          <div class="dashboard__images dashboard__images morph pic">
                            <a data-target="#lymphomaModal" data-toggle="modal">
                        ...
                        <div class="col-md-3 dashboard__framecontainer">
                          <div class="dashboard__images morph pic">
                            <a data-target="#myeloproliferativeModal" data-toggle="modal">
                        ...
                        <div class="col-md-3 dashboard__framecontainer">
                          <div class="dashboard__images morph pic">
                            <a data-target="#plasmaCellModal" data-toggle="modal">
                      ...
                      <div class="row col-md-offset-1">
                        <div class="col-md-4 dashboard__framecontainer">
                          <div class="dashboard__images morph pic">
                            <a data-target="#aapnhmdsModal" data-toggle="modal">
                        ...
                        <div class="col-md-4 dashboard__framecontainer">
                          <div class="dashboard__images morph pic">
                            <a data-target="#plateletDisorderModal" data-toggle="modal">
                        ...
                        <div class="col-md-4 dashboard__framecontainer">
                          <div class="dashboard__images morph pic">
                            <a data-target="#coagulationDiseaseModal" data-toggle="modal">
