...
<html>
<head>
<title>USTH | Lymphoma Follow Up</title>
<meta charset="utf-8">
...
<script src="js/normalrangelymphfu.js"></script>
...
<body>
  ...
  <div class="row-offcanvas row-offcanvas-left">
    ...
    <div id="main">
      <div class="col-md-12">
        ...
        <!-- End of Sidebar -->
        <!-- Forms Container -->
        <form action="" method="post" id="LymphomaFollowUp">
          <div class="col-md-12">
            <div class="col-md-12 forms">
              ...
              <div class="row button-container buttons__firsthalf--position" id="button-container">
                <div class="col-sm-6 buttons__firsthalf-position">
                  ...
                  <a href="lymphoma-followup.jsp" type="button" class="btn bg-yellow button-border followupnbtn-text"
                    id="followUpBtn">
                    <span>FollowUp</span>
                  </a>
                </div>
                    ...
                    <div id="laboratory" class="tab-pane fade in">
                      ...
                      <div class="form-horizontal">
                       ...
                       <!-- Fields -->
                        ...
                        <div class="form-group" id="imagingStudiesAttachScannedDocument" style="display: none;">
                          <label class="control-label col-lg-4">Attach scanned document</label>
                          <div class="col-sm-8">
                            <input type="file" class="form-control" name="imagingStudiesAttachScannedDocument" />
                          </div>
                        </div>
                      </div>
                      <!-- End of Form -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-5">
                            <select required class="form-control" name="diseaseStatus">
                              ...
                              <option value="RR (Relapsed/Refractory Disease)">RR (Relapsed/Refractory Disease)</option>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
              <canvas id="lymphomaFollowPatStatsChart" width="600" height="500"></canvas>
            </div>
          </div>
          <script>
											var ctx = document.getElementById("lymphomaFollowPatStatsChart").getContext('2d');
											var lymphomaFollowPatStatsChart = new Chart(ctx, {
												type : 'line',
												data : {
  ...
  <script src="js/disease.lymphoma-followup.js"></script>
