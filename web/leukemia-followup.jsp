  ...
  <div class="row-offcanvas row-offcanvas-left">
    ...
    <div id="main">
      <div class="col-md-12">
        ...
        <!-- End of Sidebar -->
        <!-- Forms Container -->
        <form action="AddLeukemiaFollowUpServlet" method="post">
          <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-5">
                            <select class="form-control" name="diseaseStatus">
                              ...
                              <option value="">nCR (near CR)</option>
                              <option value="">PR (Partial Response)</option>
                              <option value="">PD (Progressive Disease)</option>
                              <option value="">SD Stable Disease)</option>
                              <option value="">Complete Hematologic response</option>
                              <option value="">Complete Cytogenetic Response</option>
                              <option value="">Major Molecular Response</option>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" onclick="javascript:demoFromHTML();" class="btn btn-success">Generate Report</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <script id="script-construct">
											var leukemiaChartPatientStatistics = new Chart('chart-0', {
												type : 'line',
												data : {
													labels : labels,
													datasets : [ {
														backgroundColor : Samples.color(9),
          ...
          <script id="script-actions">
											function addData() {
												leukemiaChartPatientStatistics.data.labels
														.push(leukemiaChartPatientStatistics.data.labels.length);
												leukemiaChartPatientStatistics.data.datasets.forEach(function(dataset, i) {
													dataset.data.push(Samples.rand(0, 100));
												});

												leukemiaChartPatientStatistics.update();
											}

											function removeData() {
												leukemiaChartPatientStatistics.data.labels.shift();
												leukemiaChartPatientStatistics.data.datasets.forEach(function(dataset, i) {
													dataset.data.shift();
												});
          ...
          <div style="text-align: center;">
            <div class="actions">
              <input class="btn btn-primary" type="button" value="Add Data" onclick="addData(this)"> <input
                class="btn btn-success" type="button" value="Remove Data" onclick="removeData(this)">
            </div>
            <br>

            <!-- END OF LEUKEMIA CHART -->

            Hematologic Malignancy: High <br> High Concominany Medications: Medium <br> Chemotherapy
            Medications: Low <br>
          </div>
          <br>
