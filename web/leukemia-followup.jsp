...
<html>
   <head>
      ...
      <title>USTH - Leukemia Followup</title>
      <meta charset="utf-8">
                     ...
                     <div class="col-md-12 forms">
                        ...
                        <div class="row button-container buttons__firsthalf--position ">
                           ...
                           <div class="col-sm-6 text-right btn-toolbar">
                              <a href="#" type="button" class="btn bg-yellow button-border" id="patientStatsLeuk">Patient Statistics</a> 
                              <a href="#" type="button" class="btn bg-yellow button-border" id="edtPatientBtn">Edit Patient</a> 
                              <a href="#" type="button" class="btn bg-yellow button-border" id="archPatientBtn">Archive Patient</a>
                           </div>
                        </div>
                           ...
                           <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-8">
                                    ...
                                    <div class="radio">
                                       <label><input type="radio" name="molecularAnalysis">Not Done</label>
                                    </div>
                                 </div>
                              </div>
                              <div class="form-group">
