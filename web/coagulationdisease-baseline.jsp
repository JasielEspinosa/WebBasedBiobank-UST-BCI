                              ...
                              <div id="laboratory" class="tab-pane fade">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step="any" class="form-control" name="factorVIIILevel" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Factor IX level</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step="any" class="form-control" name="factorIXLevel" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Inhibitor Assay</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step="any" class="form-control" name="inhibitorAssay" />
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="control-label col-sm-4">Bethesda Units</label>
                                       <div class="col-lg-4">
                                          <input type="number" Required="required" step="any" class="form-control" name="bethesdaUnits" />
                                       </div>
                                    </div>
                                    <!-- End of fields -->
                                    <!-- Blood Chemistry -->
