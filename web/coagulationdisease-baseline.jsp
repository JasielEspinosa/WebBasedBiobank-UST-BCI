   ...
   <div class="row-offcanvas row-offcanvas-left">
      <div id="sidebar" class="sidebar-offcanvas">
         <div class="col-md-12">
            ...
            <div class="row">
               <div class="col-sm-12 add-box">
                  <button id="generateReport" type="button" class="btn bg-yellow disabled sidebar__addptngenrep--border" data-target="#genrep" data-toggle="modal" data-whatever="@mdo">Generate Report</button>
               </div>
            </div>
         ...
         <div class="col-md-12">
               ...
               <div class="col-md-12 forms">
                  ...
                  <div class="row button-container buttons__firsthalf--position ">
                     ...
                     <div class="col-sm-6 text-right btn-toolbar">
                        <a href="#" type="button" class="btn bg-yellow button-border" id="edtPatientBtn" data-target="#patstats" data-toggle="modal">Patient Statistics</a> <a href="#"
          ...
          <div class="modal fade centered-modal" id="patstats" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-sm">
             ...
             <!-- END OF COAGULATION NEOPLASM CHART -->                 
                <br>              
