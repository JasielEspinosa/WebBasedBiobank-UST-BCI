...
<html>
   <head>
      ...
      <title>USTH - Coag Baseline</title>
      <meta charset="utf-8">
                     ...
                     <div class="col-md-12 forms">
                        ...
                        <div class="row button-container buttons__firsthalf--position ">
                           <div class="col-sm-6 buttons__firsthalf-position ">
                              <a href="coagulationdisease-baseline.jsp" type="button" class="btn bg-yellow button-border" id="baselineBtn">Baseline</a> <a
                                 href="coagulationdisease-followup.jsp" type="button" class="btn bg-yellow button-border" id="followUpBtn">Follow Up</a>
                           </div>
