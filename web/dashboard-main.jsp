            ...
            <div class="navbar__nav-item--hover">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                     <li class="active"><a href="dashboard-main.jsp"> Dashboard <span class="sr-only">(current)</span>
                     </a></li>
                  ...
                  <div class="modal-body">
                     ...
                     <div id="lymphoma-carousel" class="carousel slide" data-interval="false">
                        ...
                        <ol class="carousel-indicators">
                           <li data-target="#lymphoma-carousel" data-slide-to="0" class="active" data-toggle="tooltip" data-placement="left"
                              title="Age Statistics"></li>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <div id="myelo-carousel" class="carousel slide" data-interval="false">
                        <!-- Indicators -->
                        <ol class="carousel-indicators">
                           <li data-target="#myelo-carousel" data-slide-to="0" class="active" data-toggle="tooltip" data-placement="left"
                              title="Age Statistics"></li>
                           ...
                           <div class="item">
                              <div class="carousel-label">
                                 ...
                                 <div class="form-group col-md-offset-3">
                                    <div class="col-sm-4">
                                       <label for="message-text" class="control-label">From:</label> <input type="date" class="form-control"
                                          name="fromDateAgeStats" id="baselineStatisticsFromMyeloproliferative">
                                    </div>
                                    <div class="col-sm-4">
                                       <label for="message-text" class="control-label">To:</label> <input type="date" class="form-control"
                           ...
                           <div class="carousel-inner" role="listbox">
                              <div class="item active">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="ageStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="ageStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
                              ...
                              <div class="item">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="genderStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="genderStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
                              ...
                              <div class="item">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="modeOfTreatmentStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="modeOfTreatmentStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
                              ...
                              <div class="item">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="baselineStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="baselineStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
                              ...
                              <div class="item">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="followupStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="followupStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
                              ...
                              <div class="item">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="summaryBaselineStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="summaryBaselineStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
                              ...
                              <div class="item">
                                 <div class="carousel-label">
                                    ...
                                    <div class="form-group col-md-offset-3">
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">From:</label> <input type="date"
                                             class="form-control" name="fromDateAgeStats" id="summaryFollowupStatisticsFromPlasmacell">
                                       </div>
                                       <div class="col-sm-4">
                                          <label for="message-text" class="control-label">To:</label> <input type="date"
                                             class="form-control" name="toDateAgeStats" id="summaryFollowupStatisticsToPlasmacell">
                                       </div>
                                    </div>
                                    <!-- End of To and From Date -->
                                 </div>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <div class="row">
                        ...
                        <div class="col-md-9">
                           ...
                           <p style="text-align: justify;">Aplastic anemia is a rare disease in which the bone marrow and the
                              hematopoietic stem cells that reside there are damaged. This causes a deficiency of all three blood cell types
                              (pancytopenia): red blood cells (anemia), white blood cells (leukopenia), and platelets (thrombocytopenia).</p>
                           <p class="pull-right">
                              <b>( HealthLine, 2013 )</b>
                           </p>
                        </div>
                     ...
                     <div id="aapnhmds-carousel" class="carousel slide" data-interval="false">
                        <!-- Indicators -->
                        <ol class="carousel-indicators">
                           <li data-target="#aapnhmds-carousel" data-slide-to="0" class="active" data-toggle="tooltip" data-placement="left"
                              title="Age Statistics"></li>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <div class="row">
                        ...
                        <div class="col-md-9">
                           ...
                           <p style="text-align: justify;">Platelets are little pieces of blood cells. Platelets help wounds heal and
                              prevent bleeding by forming blood clots. Problems can result from having too few or too many platelets, or
                              from platelets that do not work properly. If your blood has a low number of platelets, it is called
                              thrombocytopenia.</p>
                           <p class="pull-right">
                              <b>( MedicinePlus, 2017 )</b>
                           </p>
                        </div>
                     </div>
                     <!-- General Statistics Carousel -->
                     <div id="platelet-carousel" class="carousel slide" data-interval="false">
                        <!-- Indicators -->
                        <ol class="carousel-indicators">
                           <li data-target="#platelet-carousel" data-slide-to="0" class="active" data-toggle="tooltip" data-placement="left"
                              title="Age Statistics"></li>
                  ...
                  <div class="modal-body">
                     <div class="row">
                        ...
                        <div class="col-md-9">
                           ...
                           <p style="text-align: justify;">Severe liver disease (eg, cirrhosis, fulminant hepatitis, acute fatty liver
                              of pregnancy) may disturb hemostasis by impairing clotting factor synthesis. Because all coagulation factors
                              are made in the liver, both the PT and PTT are elevated in severe liver disorders. (PT results are typically
                              reported as INR.) Occasionally, decompensated liver disease also causes excessive fibrinolysis and bleeding
                              due to decreased hepatic synthesis of alpha 2-antiplasmin.</p>
                           <p class="pull-right">
                              <b>( Haemotologica, 2014 )</b>
                           </p>
                        </div>
                     </div>
                     <!-- General Statistics Carousel -->
