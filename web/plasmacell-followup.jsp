...
<html>
<head>
<title>USTH - Plasma Follow Up</title>
<meta charset="utf-8">
   ...
   <div class="row-offcanvas row-offcanvas-left">
      ...
      <div id="main">
         <div class="col-md-12">
            ...
            <!-- End of Sidebar -->
            <!-- Forms Container -->
            <form action="AddPlasmaCellFollowUpServlet" method="post">
               <div class="col-md-12">
                                 ...
                                 <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          ...
                                          <div class="radio">
                                             <label><input type="radio" name="serumFreeLightChainAsssay"
                                                value="0">No / Not Applicable</label>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="serumProteinElectrophoresisResult"
                                       style="display: none;">
                                       <label class="control-label col-lg-4">Result</label>
                                       <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          ...
                                          <div class="radio">
                                             <label><input type="radio" name="serumImmunofixation" value="0">No
                                                / Not Applicable</label>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="serumImmunofixationAttachScannedDocument"
                                       style="display: none;">
                                       <label class="control-label col-lg-4">Attach scanned document</label>
                                       <div class="col-sm-8">
                                          <input type="file" class="form-control"
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
                                          ...
                                          <div class="radio">
                                             <label><input type="radio" name="urineProtein" value="0">No</label>
                                          </div>
                                          <div class="radio">
                                             <label><input type="radio" name="urineProtein" value="2">Not
                                                Applicable</label>
                                          </div>
                                       </div>
                                    </div>
                              ...
                              <div id="diseaseStatus" class="tab-pane fade in">
                                 ...
                                 <div class="form-horizontal">
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-5">
                                          <select class="form-control" name="diseaseStatus">
                                             ...
                                             <option value="SCR (Stringent Complete Remission)">SCR (Stringent
                                                Complete Remission)</option>
                                             <option value="Immunophenotypic">Immunophenotypic CR</option>
                                             <option value="Molecular CR">Molecular CR</option>
                                             <option value="VGPR (Very Good Partial Response)">VGPR (Very Good
                                                Partial Response)</option>
                                             <option value="PR (Partial Response)">PR (Partial Response)</option>
                                             <option
                                                value="MR (Minimal Response for relapsed refractory myeloma
                                             only)">MR
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-5">
                                          <select class="form-control" name="relapseDisease">
                                             <option selected="selected" disabled="disabled">Select</option>
