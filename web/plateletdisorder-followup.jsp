...
<body>
   ...
   <div class="row-offcanvas row-offcanvas-left">
      ...
      <div id="main">
         <div class="col-md-12">
            ...
            <!-- End of Sidebar -->
            <!-- Forms Container -->
            <form action="" method="post" id="PlateletDisorderFollowUp">
               <div class="col-md-12">
                  <div class="col-md-12 forms">
                     ...
                     <div class="row button-container buttons__firsthalf--position ">
                        ...
                        <div class="col-sm-6 text-right btn-toolbar">
                           <a href="#" type="button" class="btn bg-yellow button-border" id="editPatientBtn" data-target="#patstats"
   ...
   <script src="js/disease.plateletdisorder-followup.js"></script>
</body>
</html>