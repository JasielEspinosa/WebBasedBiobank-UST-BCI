...
<title>USTH-BCI Biobank - Platelet Disorder</title>
         ...
         <div class="row">
            <div class="col-sm-10 offset-sm-2 pull-right forms">
               ...
               <div class="row button-container">
                  <div class="col-sm-4">
                     <a href="plateletdisorder-baseline.jsp" type="button" class="btn bg-yellow">Baseline</a> <a
                        href="plateletdisorder-followup.jsp" type="button" class="btn bg-yellow">Follow Up</a>
                  </div>
               </div>
