                          ...
                          <div class="col-lg-5">
                            <select required class="form-control" name="qualityOfResponse">
                              ...
                              <option
                                ...
                                (No Remission): platelet count &#x3C; 30 x 109/L or less than 2-fold increase the
                                baseline count or bleeding</option>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <script>
											var ctx = document.getElementById("plateletFollowPatStatsChart").getContext('2d');
