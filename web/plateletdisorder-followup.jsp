							...
							<div class="tab-content tab-content__border">
								...
								<div id="diseaseStatus" class="tab-pane fade in">
									...
									<div class="form-horizontal">
										...
										<div class="form-group">
											<label class="control-label col-lg-5">Quality of
												Response</label>
											<div class="col-lg-5">
												<select class="form-control" name="qualityOfResponse">
													...
													<option value="">R (Remission): platelet count > 30 x 109/L or at least 2-fold increase the baseline count</option>
													<option value="">NR ( No Remission): platelet count < 30 x 109/L or less than 2-fold increase the baseline count or bleeding</option>
													<option value="">Loss of Response</option>
													<option value="">Refractory ITP</option>
													<option value="">Stable Disease</option>
