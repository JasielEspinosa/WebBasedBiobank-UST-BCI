...
public class AddLymphomaBaselineServlet extends HttpServlet implements DefaultValues {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//---> Place this to AAPHSMDS Baseline Servlet <---//
		...
		String boneMarrowAspirateAndBiopsyOfTissueDatePerformed = noValue;
		String boneMarrowAspirateAndBiopsyOfTissueDescription = noValue;
		...
		if (Integer.parseInt(request.getParameter("boneMarrowAspirate")) == 1) {
			boneMarrowAspirateAndBiopsyOfTissueDatePerformed = request.getParameter("boneMarrowDatePerformed");
			boneMarrowAspirateAndBiopsyOfTissueDescription = request.getParameter("boneMarrowDescription");
		...
		BoneMarrowAspirateBean bmab = BeanFactory.getBoneMarrowAspirateBean(boneMarrowAspirateAndBiopsyOfTissueDatePerformed,
				boneMarrowAspirateAndBiopsyOfTissueDescription);
		if (connection != null) {
