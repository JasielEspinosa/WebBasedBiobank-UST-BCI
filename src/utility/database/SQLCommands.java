...
public interface SQLCommands {
	...
	String UPDATE_BLOOD_CHEMISTRY_MYELOPLORIFERATIVE = "Upddate BloodChemistryTable set Creatine = ?, UricAcid = ?, SGOT = ?, SGPT = ?, LDH = ? , EPOLevel = ? where BloodChemistryID = ? ";
	...
	String UPDATE_SERUMIMMUNOFIXIATION = "Update serumimmunofixationtable set Result = ? where SerumImmunofixationID = ?";
